            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        <a href="gamesAfterLogin.php"><i class="fa fa-home"></i> Home</a>
                        <span>Detail</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <div class="anime__details__btn">
                                <a href="login.php" class="watch-btn"><span>Buy Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="anime__details__review">
                        ...
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="images/arifprofile.jpg" alt="">
                            </div>
