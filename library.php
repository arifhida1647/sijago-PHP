      ...
      <div class="container">
         <div class="row">
            <div class="col-md-10 offset-md-1">
               <div class="titlepage">
                  <h2 style="font-size: 50px">My Library</h2>
               </div>
            </div>
         </div>
      </div>
            ...
            <?php for ($i = 0; $i < 8; $i++) { ?>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     ...
                     <h3><span class="blu">OWNED</span></h3>
                     <p><?php echo $data[$i]['nama'] ?></p>
                     <a class="read_more" href="detailgameAfterLogin.php?namaGame=<?php echo  $data[$i]['nama'] ?>">Detail</a>
                  </div>
               </div>
            <?php } ?>
         </div>
